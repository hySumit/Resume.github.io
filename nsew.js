...
<body>
    ...
    <section class="section2">
        ...
        <div class="vidcol1">
            <video src="https://storage.googleapis.com/lumen5-site-images/website-assets/public-home.webm" class="wid1" autoplay loop  muted></video>
        </div>
        <div class="reach">
    ...
    <section class="respons">
        <div class="sector3">
            <div class="row">
                <video src="https://storage.googleapis.com/lumen5-site-images/slidedeck_v4.webm" autoplay loop muted ></video>
            </div>
            <div class="row h2-black">
                <h2 class="h2-black">Easier than building a slide deck</h2>
                <div class="h3 h3-black">
                    <h3>Creating with Lumen5 is just like making a presentation. Point and click, drag and drop,
                        done and done.</h3>
                </div>
    ...
    <section class="section3">
        <div class="sector3">
            ...
            <div class="row row-video">
                <video src="https://storage.googleapis.com/lumen5-site-images/website-assets/ai-repurpose-3.webm" autoplay loop muted ></video>
            </div>
        </div>
    ...
    <section class="section4">
        <div class="sector3">
            <div class="row">
                <video src="https://storage.googleapis.com/lumen5-site-images/website-assets/choose-template.webm" autoplay loop muted></video>
            </div>
            <div class="row h2-black">
    ...
    <section class="section5">
        <video src="https://storage.googleapis.com/lumen5-site-images/website-assets/public-templates.webm" autoplay loop muted ></video>
    </section>
    <section class="section6">
        <div class="shutter-vid">
            <video src="https://storage.googleapis.com/lumen5-site-images/website-assets/media-search.webm" autoplay loop muted></video>
        </div>
        <div id="h1">
    ...
    <section class="section9">
        ...
        <div class="row learning-vid-9">
            <video src="https://storage.googleapis.com/lumen5-site-images/website-assets/learning-resources.webm" autoplay loop muted></video>
        </div>
    </section>
